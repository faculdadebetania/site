  ...
  return (
    <main className="container">
      ...
      <ul>
        ...
        <h3 className="text-xl uppercase font-bold tracking-wider mt-4">
          Integrais
        </h3>
        <Document href="/documentos/cpa/relatorio-cpa-2023.pdf">
          Relatório CPA 2023
        </Document>
        ...
        <h3 className="text-xl uppercase font-bold tracking-wider mt-8">
          Parciais
        </h3>
