...
export default async function Page() {
  const { startDate, name, category, modality, duration, period, price, priceDisclaimer, classSchedule, weekDays } =
    await getCourse('capelania');

  return (
    <main className="flex flex-col">
      <CourseHero>
        <CourseHeroBackground src={`/imagens/capelania/hero.jpg`} />
        <CourseHeroTitle>{name}</CourseHeroTitle>
        <CourseHeroSubtitle>{category}</CourseHeroSubtitle>
        <div className="flex items-center gap-4">
          <CourseHeroAction href="https://forms.gle/jK6FMYTqfamkLzXk8">Inscrição</CourseHeroAction>
          <CourseHeroAction
      ...
      <CourseInfo>
        <div className="grid grid-cols-1 lg:grid-cols-3 justify-center items-start gap-8">
          <CourseInfoVideo source={`/videos/capelania.mp4`} className="lg:w-[384px]" />
          <div className="flex flex-col">
            <h3 className="font-bold uppercase text-primary">O que é o curso?</h3>
            <p className="text-primary">
              O curso de Capelania tem como objetivo principal fomentar, treinar, equipar de forma prática o exercício da
              capelania em seus diversos contextos de atuação, de maneira que a assistência religiosa seja assertiva e eficaz.
            </p>
          </div>
          <div className="text-primary">
            <h3 className="uppercase font-bold">Temas Abordados</h3>
            <ul>
              <li>&bull;&nbsp;Conceito e desenvolvimento histórico da Capelania</li>
              <li>&bull;&nbsp;O que é e o que não é capelania</li>
              <li>&bull;&nbsp;Os contextos de atuação da Capelania</li>
              <li>&bull;&nbsp;Diferenciação da Capelania Voluntária e Capelania Profissional</li>
              ...
              <li>
                &bull;&nbsp;Capelania Hospitalar de forma prática e assertiva. (Assepsia, Abordagens, Visitação em UTI, Etc)
              </li>
      ...
      <section className="container bg-primary flex flex-col gap-8" id="corpo-docente">
        ...
        <section className="flex items-center gap-16">
          ...
          <section className="flex flex-col gap-4">
            <h3 className="uppercase font-bold text-secondary text-4xl">Adriano Cruz</h3>
            <Separator className="bg-secondary !m-0 opacity-25" />
            <p>
              Escritor do livro Diário do Capelão, capelão do projeto Valores em Construção, fundador do projeto Loly e o
              Pequeno Marruquinho, professor, radialista, palestrante, bacharel em Teologia, pós-graduado em Gestão de Pessoas,
              especialista em Marketing e Comunicação e pós-graduado em Psicologia.
            </p>
            <p>
              Atualmente atende 34 escolas públicas na região de Palmeira- PR, algo em torno de 700 professores, 34 diretores e
              mais de 10 mil alunos. Pela Transmundial do Brasil é responsável pela implantação e treinamento de equipes de
              capelania escolar em várias cidades no Brasil e America Latina.
            </p>
          </section>
        </section>
      </section>
